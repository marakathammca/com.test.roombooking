 ...
 */
class CRM_Roombooking_Form_Roombooking extends CRM_Core_Form {
 ...
 $this->assign('label','Enter the room details');
  ...
  function postProcess() {
    $this->createRoom();
    $path = 'civicrm/roombookingconfirmation';
...
/**
   ...
   */
  function addRules() {
$this->addFormRule(array('CRM_Roombooking_Form_Roombooking', 'checkRules'));
          return;
    }
